...
const displayNews = (data) =>{
    ...
    data.map((item)=>{
        ...
        article_image.width = "338";

        article_image.onerror =() =>{
            article_image.onerror =null;
            article_image.src = "../assets/image/person-gray-photo-placeholder-man-shirt-white-background-person-gray-photo-placeholder-man-132818487.jpg";
        }
